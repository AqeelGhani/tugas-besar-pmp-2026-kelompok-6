...
void CetakTampilanMenu() {
    Serial.println("\n==================================================");
    Serial.println("      SISTEM INVENTARIS LAB EMBEDDED SYSTEMS      ");
    Serial.println("==================================================");
    Serial.println("1. Tambah Data Barang      ");
    Serial.println("2. Hapus Data Barang       ");
    Serial.println("3. Cari Data Berdasarkan ID");
    Serial.println("4. Perbarui Stok Barang    ");
    Serial.println("5. Perbarui Status         ");
    Serial.println("6. Tampilkan semua item    ");
    Serial.println("7. Ringkasan Inventaris    ");
    Serial.println("8. Save to EEPROM          ");
    Serial.println("==================================================");
    Serial.print("Masukkan pilihan Anda (1-7): ");
}
